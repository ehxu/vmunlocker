...
******* READ HERE: *********
WINDOWS USERS: Get the tool from the Releases section, you will get a bundled python distribution which avoids the virus warnings and python not found etc.
